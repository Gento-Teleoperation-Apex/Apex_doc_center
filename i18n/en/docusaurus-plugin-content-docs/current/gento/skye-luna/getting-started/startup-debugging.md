...
Start the teleoperation backend:
...
7. Verify the physical pose of both arms and the knee joints.
...
After connection, test small arm motions first, then verify torso and leg mapping. Increase the range only after all directions are correct.
...
| Arms move but lower body does not | Tracker charge, placement, and tracking state |
