...
sidebar_label: PICO User Manual
sidebar_position: 4
---
...
Follow [Pico App Installation](./pico-app-installation.md), then open the application while both controllers are tracked and accept the required permission and system prompts.
